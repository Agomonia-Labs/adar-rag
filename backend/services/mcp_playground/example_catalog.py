...
def example_catalog() -> list[dict]:
    ...
    examples = [
        ...
        _tool("Knowledge Academy", "get_learning_calendar", {"course_id": course}, "Read announcements, deadlines, and assignment due dates."),
        _tool("Knowledge Academy", "create_learning_calendar_item", {"course_id": course, "item_type": "announcement", "title": "Live review session", "description": "Bring questions from the RAG module.", "starts_at": "2026-10-05T17:00:00Z", "ends_at": "2026-10-05T18:00:00Z", "all_day": False}, "Publish a course announcement or deadline."),
        _tool("Knowledge Academy", "update_learning_calendar_item", {"course_id": course, "item_id": "YOUR_CALENDAR_ITEM_ID", "changes": {"title": "Updated live review session"}}, "Update a staff-managed calendar item."),
        _tool("Knowledge Academy", "delete_learning_calendar_item", {"course_id": course, "item_id": "YOUR_CALENDAR_ITEM_ID", "confirm": True}, "Delete a staff-managed calendar item."),
    ...
    resources = [
        ...
        ("Learning calendar", "docintel://learning/courses/YOUR_COURSE_ID/calendar", "Read announcements and course or assignment deadlines."),
