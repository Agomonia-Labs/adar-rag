...
def example_catalog() -> list[dict]:
    ...
    examples = [
        ...
        _tool("Knowledge Academy", "create_learning_course", {"workspace_id": ws, "title": "AI Foundations", "course_code": "AI-101", "semester": "Fall 2026", "description": "Evidence-grounded AI learning.", "instructor_name": "Course Instructor", "objectives": ["Explain RAG", "Evaluate grounded answers"]}, "Create a workspace-governed course."),
        ...
        _tool("Knowledge Academy", "attach_learning_content", {"course_id": course, "document_id": doc, "module_id": module, "lesson_id": lesson, "title": "Hybrid Retrieval Lesson"}, "Map embedded content into the curriculum."),
