...
DOCUMENT_TYPES = [
    ...
    "training_record", "project_record",
    # Medical
...
HEURISTIC_RULES = [
    ...
    ("performance_review", "hr", ("performance review", "performance evaluation", "annual review", "manager feedback", "employee goals")),
    ...
    ("training_record", "hr", ("training record", "learning transcript", "course completion", "completed training")),
    ("project_record", "hr", ("project record", "project summary", "project accomplishments", "project outcomes")),
...
DOC_TYPE_LABELS = {
    ...
    "performance_review": "Review",     "skills_profile": "Skills Profile",
    "certification_record": "Certification", "training_record": "Training",
