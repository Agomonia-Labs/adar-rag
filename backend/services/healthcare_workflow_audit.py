...
HEALTHCARE_PERSONAS: dict[str, dict[str, Any]] = {
    ...
    "nurse_care_coordinator": {
        ...
        "workspace_roles": ["owner", "editor"],
        "can_approve": False,
        "can_edit": ["patient_context", "care_gaps", "followup_checklist", "patient_summary", "clinical_summary"],
    ...
    "clinic_admin": {
        ...
        "workspace_roles": ["owner", "editor"],
        "can_approve": False,
        "can_edit": ["patient_context", "care_gaps", "followup_checklist", "prior_auth_packet"],
    ...
    "prior_auth_billing": {
        ...
        "workspace_roles": ["owner", "editor"],
        "can_approve": False,
        "can_edit": ["prior_auth_request", "policy_criteria", "evidence_map", "gap_detection", "prior_auth_packet"],
