...
def test_catalog_covers_registered_tools_and_resources():
    ...
    expected = {
        ...
        "retry_batch_failures", "cancel_batch_job",
            "list_learning_domain_packs", "list_learning_courses", "get_learning_course", "create_learning_course", "update_learning_course",
        "delete_learning_course", "save_learning_curriculum", "enroll_learning_member", "remove_learning_member",
        "update_learning_profile", "get_learning_directory",
        "get_learning_calendar", "create_learning_calendar_item", "update_learning_calendar_item", "delete_learning_calendar_item",
        ...
        "create_learning_assignment", "submit_learning_assignment", "evaluate_learning_submission",
        "review_learning_submission", "get_learning_instructor_dashboard",
    ...
    assert sum(item["category"] == "Resources" for item in catalog) == 32
