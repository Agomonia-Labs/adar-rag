          ...
          <main style={s.main}>
            ...
            <section style={s.band}>
              <div style={s.bandHead}>
                <h3 style={s.sectionTitle}>Processing Status</h3>
            ...
            <section style={s.band}>
              <h3 style={s.sectionTitle}>Ask About This Video</h3>
              <div style={s.askRow}>
                <textarea
                  value={question}
              ...
              {!timeline?.segments?.length ? (
                ...
                <div style={s.timeline}>
                  {timeline.segments.map(seg => (
                    <article key={seg.id} style={s.segment}>
            ...
            <section style={s.band}>
              <h3 style={s.sectionTitle}>Sampled Frames</h3>
...
const s = {
  ...
  optionBox: { display:'flex', flexDirection:'column', gap:9, padding:10, border:'1px solid var(--b2)', borderRadius:8, background:'rgba(255,255,255,.02)' },
  ...
  sectionTitle: { margin:'0 0 10px', fontSize:15, color:'var(--tx)', letterSpacing:0 },
...
if (typeof window !== 'undefined') {
  ...
  style.textContent = `
    @media (max-width: 760px) {
      div[style*="grid-template-columns: 300px minmax(0, 1fr)"] {
        grid-template-columns: 1fr !important;
        overflow-y: auto !important;
      }
      div[style*="border-right: 1px solid rgba(74, 222, 128, 0.14)"] {
      ...
      article[style*="grid-template-columns: 110px"] {
        grid-template-columns: 1fr !important;
      }
    }
  `;
