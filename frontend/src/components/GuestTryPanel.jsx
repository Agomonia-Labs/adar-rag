...
const s = {
  shell:{ minHeight:'100vh', display:'grid', gridTemplateColumns:'minmax(280px, .9fr) minmax(320px, 1.1fr)', gap:24, padding:'clamp(18px, 4vw, 48px)', background:'var(--bg)', color:'var(--tx)' },
  ...
  hero:{ alignSelf:'center', maxWidth:620 },
  heroMobile:{ alignSelf:'stretch', maxWidth:'none' },
  brand:{ display:'flex', alignItems:'center', gap:8, color:'#4ade80', fontWeight:800, marginBottom:18 },
  brandMobile:{ marginBottom:8 },
  h1:{ fontSize:'clamp(34px, 6vw, 64px)', lineHeight:1, margin:'0 0 16px', letterSpacing:0 },
  ...
  copy:{ color:'var(--tx2)', fontSize:16, lineHeight:1.65, margin:'0 0 20px' },
  ...
  docList:{ display:'flex', flexDirection:'column', gap:8, minHeight:88, marginTop:8 },
  docListMobile:{ maxHeight:'26dvh', overflowY:'auto', minHeight:0, paddingRight:2, WebkitOverflowScrolling:'touch' },
  empty:{ color:'#7f927f', border:'1px dashed rgba(148,163,184,.25)', borderRadius:8, padding:18, textAlign:'center' },
  doc:{ display:'flex', alignItems:'center', gap:10, padding:10, border:'1px solid rgba(148,163,184,.16)', background:'#102612', borderRadius:8 },
  ...
  summaryBox:{ marginTop:14, padding:14, border:'1px solid var(--teal-mid)', background:'linear-gradient(135deg, var(--s2), rgba(74,222,128,.08))', borderRadius:10, boxShadow:'inset 0 1px 0 rgba(255,255,255,.05)' },
  qaBox:{ marginTop:14, padding:14, border:'1px solid rgba(96,165,250,.24)', background:'linear-gradient(135deg, var(--s2), rgba(96,165,250,.07))', borderRadius:10, boxShadow:'inset 0 1px 0 rgba(255,255,255,.05)' },
  ...
  summaryOutput:{ maxHeight:260, overflowY:'auto', padding:12, background:'var(--bg)', color:'var(--tx)', lineHeight:1.75, fontSize:14 },
  ...
  textarea:{ minHeight:82, resize:'vertical', borderRadius:9, border:'1px solid var(--b2)', background:'var(--s3)', color:'var(--tx)', padding:11, outline:'none', boxShadow:'inset 0 1px 0 rgba(255,255,255,.04)' },
  ...
  answer:{ padding:12, background:'var(--bg)', color:'var(--tx)', lineHeight:1.75, fontSize:14 },
